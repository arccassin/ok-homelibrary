...
kotlin {
    ...
    targets.withType<org.jetbrains.kotlin.gradle.plugin.mpp.KotlinNativeTarget> {
        binaries {
            executable {
                entryPoint = "com.otus.otuskotlin.homelibrary.app.ktor.main"
            }
        }
    }
...
//                implementation("io.ktor:ktor-server-double-receive:${libs.versions.ktor.get()}")
                ...
                implementation(projects.homelibraryAppCommon)
                implementation(projects.homelibraryBiz)
                ...
                implementation(projects.homelibraryCommon)
                implementation(projects.homelibraryRepoStubs)
                implementation(projects.homelibraryRepoInmemory)

                // logging
                implementation(projects.homelibraryApiLog)
                implementation("com.otus.otuskotlin.homelibrary.libs:homelibrary-lib-logging-common")
                implementation("com.otus.otuskotlin.homelibrary.libs:homelibrary-lib-logging-kermit")
            }
        }
        ...
        val jvmMain by getting {
            dependencies {
                ...
                implementation(projects.homelibraryRepoPgjvm)
