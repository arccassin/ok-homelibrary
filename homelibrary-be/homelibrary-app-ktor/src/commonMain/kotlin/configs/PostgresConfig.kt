package com.otus.otuskotlin.homelibrary.app.ktor.configs
...
data class PostgresConfig(
    ...
    val database: String = "homelibrary-eds",
    ...
    constructor(config: ApplicationConfig): this(
        ...
        database = config.propertyOrNull("$PATH.database")?.getString() ?: "homelibrary-eds",
